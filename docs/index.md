...
WinUI 3 provides Fluent Design controls, data binding, deployment options, and access to Windows platform APIs. Developers coming from WPF, Windows Forms, or UWP can use the resources in this section to choose controls and architecture for common business-app requirements.
...
| Deploy to managed devices | Compare MSIX and unpackaged deployment against your organization's servicing and management requirements. |
...
The [WinUI LOB samples repository](https://github.com/GrantMeStrength/LOB) contains buildable examples for the scenarios in this section.
